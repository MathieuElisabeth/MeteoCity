            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            json = _a.sent();
                            temperature_1.innerHTML = Math.floor(json.main.temp - kelvin) + "\u00B0<span>C</span>";
                            location_1.innerHTML = json.name + ', ' + json.sys.country;
                            icon_1.src = 'images/icons/black/png/64x64/' + json.weather[0].icon + '.png';
